...
<html>
    ...
    <body>
    	...
    	<div class="container-fluid">
    	  ...
    	  <div class="col-sm-8">
    		<form method="post" action="serverStudentSignup.php">
		<div class="alert alert-info text-center">Student Signup Form</div>
    	...
    	<script>
         $(document).ready(function(){
              ...
              $("#name").blur(function(){
                ...
                {
                  $("#studentNumber").css("border","solid red 1px");
                }
                else
                {
                  $("#studentNumber").css("border","solid green 1px");
                }
              });
